...
export const CARD_DATABASE: Card[] = [
  ...
  },
  {
    ...
    type: CardType.BEAST,
    mythology: Mythology.GREEK,
    description: 'Aerial creature with sharp claws',
    imageUrl: getCardImagePath('greek_harpy', Mythology.GREEK, CardType.BEAST),
    hp: 6,
    maxHp: 6,
    attacks: [
      { name: 'Regeneration', damage: 0, description: 'Heals 3 HP to self or ally' },
  ...
  },
  {
    ...
    type: CardType.BEAST,
    mythology: Mythology.GREEK,
    description: 'Créature hybride crachant le feu',
    imageUrl: getCardImagePath('greek_chimera', Mythology.GREEK, CardType.BEAST),
    hp: 6,
    maxHp: 6,
    attacks: [
      { name: 'Regeneration', damage: 0, description: 'Heals 3 HP to self or ally' },
  ...
  },
  {
    ...
    type: CardType.BEAST,
    mythology: Mythology.GREEK,
    description: 'Créature forestière mi-homme mi-bouc',
    imageUrl: getCardImagePath('greek_satyr', Mythology.GREEK, CardType.BEAST),
    hp: 6,
    maxHp: 6,
    attacks: [
      { name: 'Regeneration', damage: 0, description: 'Heals 3 HP to self or ally' },
  ...
  },
  {
    ...
    type: CardType.BEAST,
    mythology: Mythology.GREEK,
    description: 'Géant à un œil d\'une force colossale',
    imageUrl: getCardImagePath('greek_cyclops', Mythology.GREEK, CardType.BEAST),
    hp: 6,
    maxHp: 6,
    attacks: [
      { name: 'Regeneration', damage: 0, description: 'Heals 3 HP to self or ally' },
